...
def cast_user_to_user_dto(user: User, is_detail: bool):
    if is_detail:
        return DetailUserDto(user.get_id(), user.get_username(), user.get_name(), user.get_phone_number(), str(user.get_role()))
    else:
        return UserDto(user.get_id(), user.get_username(), user.get_name())

# cast UserDto to User
def cast_user_dto_to_user(user_dto: UserDto):
    return User(user_dto.get_id(), user_dto.get_username(), user_dto.get_name(), user_dto.get_phone_number(), str(user_dto.get_role()))
